-- Rose-Hulman Tennis App - Fix Profiles RLS Infinite Recursion (Public Schema)
-- Previous migration failed due to auth schema permissions
-- Solution: Create helper function in PUBLIC schema instead

-- =====================================================
-- STEP 1: Create a helper function in PUBLIC schema
